...
- `confluence_version` The specific version of Confluence to download (default: `8.5.6`).
- `confluence_archive_name` Confluence archive name (default: `atlassian-confluence-8.5.6.tar.gz`).
